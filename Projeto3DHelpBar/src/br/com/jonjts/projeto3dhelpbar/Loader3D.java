...
public class Loader3D extends JFrame
    ...
    private void initGUI() /* The GUI consists of the 3D canvas in the center, and a column
    ...
    private void showRotInfo() {
        Point3d rot = w3d.getRotations();
        rotTF.setText("(" + df.format(rot.x) + " , " + df.format(rot.y) + " , " + df.format(rot.z) + ")");
    }
